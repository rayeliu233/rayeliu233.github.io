  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/chouseki_pic/rl_head_resized-modified.png" alt="Raye" className="mb-4" />
          <h1 className="mb-2 mt-0">Raye Liu</h1>
          <p>
            I'm {" "}
            <Typed
              strings={[
                "a CS PhD student at U of R",
                "a member of the ROCHCI lab",
                "a programmer",
                "a data scientist",
                "a musician",
                "a cat person",
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://github.com/raye2333">
                <i className="fab fa-github"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/raye-zipei-liu-8a64b5184">
                <i className="fab fa-linkedin"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="mailto:rayeliu233@gmail.com">
                <i className="fab fa-google"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="weixin://dl/chat?tormentta">
        ...
        <div className="parallax" data-relative-input="true">
          ...
          >
            <g fill="#207F4C" fillRule="evenodd">
